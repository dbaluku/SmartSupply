...
<head>
    ...
    <link rel="stylesheet" href="${baseUrl }/static/files/assets/pages/waves/css/waves.min.css" type="text/css" media="all">
    <!-- themify icon -->
    <link rel="stylesheet" type="text/css" href="${baseUrl }/static/files/assets/icon/themify-icons/themify-icons.css">
    <!-- Font Awesome -->
    <link rel="stylesheet" type="text/css" href="${baseUrl }/static/files/assets/icon/font-awesome/css/font-awesome.min.css">
    <!-- scrollbar.css -->
...
<!-- Chart js -->
<script type="text/javascript" src="${baseUrl }/static/files/bower_components/chart.js/js/Chart.js"></script>
<!-- amchart js -->
<script src="${baseUrl }/static/files/assets/js/amcharts.js"></script>
<script src="${baseUrl }/static/files/assets/pages/widget/amchart/gauge.min.js"></script>
<script src="${baseUrl }/static/files/assets/pages/widget/amchart/serial.min.js"></script>
<script src="${baseUrl }/static/files/assets/pages/widget/amchart/light.min.js"></script>
<script src="${baseUrl }/static/files/assets/pages/widget/amchart/pie.min.js"></script>
<script src="${baseUrl }/static/files/assets/js/export.min.js"></script>
<!-- Google map js -->
<script src="${baseUrl }/static/files/assets/js/markerclusterer.js"></script>
<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=true"></script>
<script type="text/javascript" src="${baseUrl }/static/files/assets/pages/google-maps/gmaps.js"></script>
...
<!-- custom js -->
<script type="text/javascript" src="${baseUrl }/static/files/assets/pages/dashboard/custom-dashboard.js"></script>
