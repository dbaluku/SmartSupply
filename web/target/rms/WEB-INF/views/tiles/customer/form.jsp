            ...
            <div class="page-body">
                <div class="card">
                    ...
                    <div class="card-block">
                        <form:form action="${baseUrl }/customer/save/customer" commandName="objectKey"  enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 col-lg-6">
                                    <div class="input-group">
                                        <form:input type="text" path="phoneNo" id="txtName" class="form-control" placeholder="PhoneNo"/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
